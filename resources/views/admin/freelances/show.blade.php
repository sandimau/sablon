        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <ul class="nav nav-tabs mb-4" id="freelanceTab" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                        <a class="nav-link {{ $tab == 'riwayat_pembayaran' ? 'active' : '' }}"
                            href="{{ route('freelances.show', $freelance->id) }}?tab=riwayat_pembayaran&bulan={{ $bln }}&tahun={{ $thn }}"
                            role="tab">
                            <i class="bx bx-receipt"></i> Riwayat Pembayaran
                        </a>
                    </li>
                </ul>
                ...
                <div class="tab-content" id="freelanceTabContent">
                    ...
                    @if ($tab == 'profil')
                        ...
                        <div class="tab-pane fade show active" id="profil" role="tabpanel">
                            <!-- Filter Form -->
                            <div class="mb-4">
                                <form action="{{ route('freelances.show', $freelance->id) }}" method="get"
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        <select name="bulan" id="bulan" class="form-control">
                                            @foreach (['01' => 'Januari', '02' => 'Februari', '03' => 'Maret', '04' => 'April', '05' => 'Mei', '06' => 'Juni', '07' => 'Juli', '08' => 'Agustus', '09' => 'September', '10' => 'Oktober', '11' => 'November', '12' => 'Desember'] as $key => $value)
                                                <option value="{{ $key }}" {{ $bln == $key ? 'selected' : '' }}>
                                                    {{ $value }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <table class="table table-borderless">
                                                ...
                                                <tr>
                                                    <th>Tanggal Masuk</th>
                                                    <td>{{ $freelance->tanggal_masuk ? $freelance->tanggal_masuk->format('d F Y') : '-' }}
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <th>Status</th>
                                                    <td>
                                                        <span
                                                            class="badge {{ $freelance->is_active ? 'bg-success' : 'bg-danger' }}">
                                        ...
                                        <div class="card-body">
                                            <table class="table table-borderless">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>Rp
                                                        {{ number_format($freelance->rate_lembur_per_jam, 0, ',', '.') }}
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <th>Bank</th>
                                            ...
                                            <div class="row">
                                                <div class="col-md-5">
                                                    <table class="table table-sm table-borderless mb-0">
                                                        <tr>
                                                            ...
                                                            <td
                                                                class="text-end {{ $sisaUpah > 0 ? 'text-danger fw-bold' : 'text-success' }}">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td
                                                                class="text-end {{ $sisaLembur > 0 ? 'text-danger fw-bold' : 'text-success' }}">
                                                        ...
                                                        <tr class="border-top">
                                                            ...
                                                            <td
                                                                class="text-end {{ $sisaUpah + $sisaLembur > 0 ? 'text-danger fw-bold' : 'text-success' }}">
                                                                <strong>Rp
                                                                    {{ number_format($sisaUpah + $sisaLembur, 0, ',', '.') }}</strong>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </div>
                                                <div class="col-md-7 text-end">
                                                    ...
                                                    @if ($sisaUpah > 0 || $sisaLembur > 0)
                                                        <a href="{{ route('freelance.bayar_semua', ['freelance' => $freelance->id, 'bulan' => $bln, 'tahun' => $thn]) }}"
                                                            class="btn btn-success me-1 mb-2">
                                                            <i class="bx bx-money"></i> Bayar Semua (Rp
                                                            {{ number_format($sisaUpah + $sisaLembur, 0, ',', '.') }})
                                                        </a>
                                                    @endif

                                                    {{-- Tombol Print Slip --}}
                                                    @if ($pembayaran)
                                                        <a href="{{ route('freelance.pembayaran.print', $pembayaran->id) }}"
                                                            class="btn btn-primary mb-2" target="_blank">
                                                            <i class="bx bx-printer"></i> Print Bukti Pembayaran
                                                        </a>
                                                    @endif
                                    ...
                                    <tbody>
                                        @foreach ($hutangUpah as $hutang)
                                            ...
                                            <tr>
                                                ...
                                                <td align="right">Rp {{ number_format($hutang->jumlah, 0, ',', '.') }}
                                                </td>
                    ...
                    @if ($tab == 'kasbon')
                        ...
                        <div class="tab-pane fade show active" id="kasbon" role="tabpanel">
                            <div class="card-header mb-4">
                                @can('kasbon_create')
                                    <a href="{{ route('freelance_kasbon.create', $freelance->id) }}"
                                        class="btn btn-success text-white me-1">
                                        <i class="bx bxs-plus-circle"></i> Tambah Kasbon
                                    </a>
                                    @if ($saldoKasbon > 0)
                                        <a href="{{ route('freelance_kasbon.bayar', $freelance->id) }}"
                            ...
                            <div class="row mb-4">
                                <div class="col-md-4">
                                    <div class="card border-{{ $saldoKasbon > 0 ? 'danger' : 'success' }}">
                                        <div class="card-body text-center">
                                            <h6 class="card-title text-{{ $saldoKasbon > 0 ? 'danger' : 'success' }}">
                                                Saldo Kasbon</h6>
                                    ...
                                    <tbody>
                                        @foreach ($kasbons as $kasbon)
                                            <tr>
                                                ...
                                                <td align="right">Rp
                                                    {{ number_format($kasbon->pemasukan ?? 0, 0, ',', '.') }}</td>
                                                <td align="right">Rp
                                                    {{ number_format($kasbon->pengeluaran ?? 0, 0, ',', '.') }}</td>
                                                <td align="right">Rp
                                                    {{ number_format($kasbon->saldo ?? 0, 0, ',', '.') }}</td>
                                            </tr>
                                        @endforeach
                                    </tbody>
                                </table>
                    ...
                    @if ($tab == 'riwayat_pembayaran')
                        <!-- Tab Riwayat Pembayaran -->
                        <div class="tab-pane fade show active" id="riwayat_pembayaran" role="tabpanel">
                            <div class="card">
                                <div class="card-header">
                                    <h5 class="card-title mb-0">
                                        <i class="bx bx-receipt"></i> Riwayat Pembayaran Gaji
                                    </h5>
                                </div>
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table table-bordered table-hover" id="tableRiwayatPembayaran">
                                            ...
                                            <tbody>
                                                @forelse($riwayatPembayaran as $item)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <strong>{{ \Carbon\Carbon::create()->month($item->bulan)->translatedFormat('F') }}
                                                                {{ $item->tahun }}</strong>
                                                        </td>
                                                        <td class="text-end">Rp
                                                            {{ number_format($item->total_upah, 0, ',', '.') }}</td>
                                                        <td class="text-end">Rp
                                                            {{ number_format($item->total_lembur, 0, ',', '.') }}</td>
                                                        <td class="text-end">Rp
                                                            {{ number_format($item->total_pembayaran, 0, ',', '.') }}</td>
                                                        <td class="text-end">
                                                            @if ($item->potongan_kasbon > 0)
                                                                <span class="text-danger">(Rp
                                                                    {{ number_format($item->potongan_kasbon, 0, ',', '.') }})</span>
                                                            @else
                                                                -
                                                            @endif
                                                        </td>
                                                        <td class="text-end">
                                                            <strong class="text-success">Rp
                                                                {{ number_format($item->total_keluar, 0, ',', '.') }}</strong>
                                                        </td>
                                                        <td>{{ $item->akunDetail->nama ?? '-' }}</td>
                                                        <td>
                                                            <a href="{{ route('freelance.pembayaran.print', $item->id) }}"
    ...
    <script>
        $(document).ready(function() {
            ...
            @elseif ($tab == 'riwayat_pembayaran')
                new DataTable('#tableRiwayatPembayaran', {
                    order: [
                        [1, 'desc']
                    ],
                    pageLength: 25,
